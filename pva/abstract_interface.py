...
class UsersOutput(OutputInterface):
    """Class generate string for shows all contacts."""
    LIMIT = 5

    def create_output(self, contact_dictionary: AddressBook) -> list:
...
class UserOutput(OutputInterface):
    """Class generate string for shows all information about contact."""
...
class HelpInfoOutput(OutputInterface):
    """Class generate string for shows all commands."""
    def create_output(self) -> str:
...
class NotesOutput(OutputInterface):
    """Class generate string for all notes or some notes by tags."""
    def create_output(self, tasks: str, note_book: NoteBook) -> str:
...
class NoteOutput(OutputInterface):
    """Class generate string for note which finds by a name."""
    def create_output(self, value: str, note_book: NoteBook) -> str:
